...
<a href="https://github.com/SanhitaKadam">
...
[![](https://komarev.com/ghpvc/?username=SanhitaKadam&color=00d9ff&style=for-the-badge&label=PROFILE+VIEWS)](https://github.com/SanhitaKadam)
[![](https://img.shields.io/github/followers/SanhitaKadam?style=for-the-badge&color=00cfff&labelColor=0d1117&label=FOLLOWERS&logo=github)](https://github.com/SanhitaKadam?tab=followers)
...
|---|---|---|
| 🏦 **[Online Banking System](https://github.com/SanhitaKadam)** — secure MVC banking web app | `Java` `J2EE` `Servlets` `JSP` `MySQL` | ACID-compliant JDBC transactions under concurrent load |
| 📧 **[AI Email Automation Agent](https://github.com/SanhitaKadam)** — Gmail triage + AI drafting | `n8n` `Gemini API` `Gmail API` `OAuth 2.0` | Multi-stage workflow, sentiment analysis, auto-drafts |
| 🎟️ **[EventX — Venue Management System](https://github.com/SanhitaKadam)** — event platform | `Java` `JSP` `Servlets` `MySQL` | Dynamic workflows, multi-entity relational DB design |
| ♻️ **[AI Waste Classification Suite](https://github.com/SanhitaKadam)** — plastic/metal/organic sorter | `Python` `Meta Llama 3.2` `Streamlit` | Lightweight 3B model tuned for low-resource devices |
...
<a href="https://github.com/SanhitaKadam" target="_blank">
